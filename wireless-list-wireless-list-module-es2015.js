...
class ExcelService {
    ...
    export(calculateForm) {
        ...
        const ws = xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].aoa_to_sheet(mapData);
        xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].book_append_sheet(wb, ws, 'map');
        // defaultBS
        ...
        const baseStationWS = xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].aoa_to_sheet(baseStationData);
        xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].book_append_sheet(wb, baseStationWS, 'base_station');
        // candidate
        ...
        const candidateWS = xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].aoa_to_sheet(candidateData);
        xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].book_append_sheet(wb, candidateWS, 'candidate');
        // UE
        ...
        const ueWS = xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].aoa_to_sheet(ueData);
        xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].book_append_sheet(wb, ueWS, 'ue');
        // obstacle
        ...
        const obstacleWS = xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].aoa_to_sheet(obstacleData);
        xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].book_append_sheet(wb, obstacleWS, 'obstacle');
        // bs parameters
        const bsData = [
        ...
        const bsWS = xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].aoa_to_sheet(bsData);
        xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].book_append_sheet(wb, bsWS, 'bs parameters');
        ...
        const algorithmWS = xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].aoa_to_sheet(algorithmData);
        xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].book_append_sheet(wb, algorithmWS, 'algorithm parameters');
        // objective parameters
        const objectiveData = [
            ['objective', 'objectiveStopCondition', 'newBsNum'],
            [calculateForm.objectiveIndex, '', calculateForm.availableNewBsNumber]
        ];
        const objectiveWS = xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].aoa_to_sheet(objectiveData);
        xlsx__WEBPACK_IMPORTED_MODULE_1__["utils"].book_append_sheet(wb, objectiveWS, 'objective parameters');
        console.log(wb);
        /* save to file */
        xlsx__WEBPACK_IMPORTED_MODULE_1__["writeFile"](wb, `${calculateForm.taskName}.xlsx`);
    }
}
...
class WirelessListRoutingModule {
}
WirelessListRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: WirelessListRoutingModule });
WirelessListRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function WirelessListRoutingModule_Factory(t) { return new (t || WirelessListRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)],
        _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WirelessListRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](WirelessListRoutingModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
...
/* harmony import */ var _new_planning_new_planning_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../new-planning/new-planning.component */ "./src/app/new-planning/new-planning.component.ts");
...
/* harmony import */ var _service_excel_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../service/excel.service */ "./src/app/service/excel.service.ts");
/* harmony import */ var _service_pdf_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../service/pdf.service */ "./src/app/service/pdf.service.ts");
/* harmony import */ var _angular_material_button__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/material/button */ "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/button.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _site_pdf_pdf_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../site/pdf/pdf.component */ "./src/app/site/pdf/pdf.component.ts");
...
const _c0 = ["pdf"];
function WirelessListComponent_tr_24_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function WirelessListComponent_tr_24_Template_i_click_10_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r5); const item_r3 = ctx.$implicit; const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r4.exportPDF(item_r3.taskId); });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
function WirelessListComponent_tr_25_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "tr");
...
class WirelessListComponent {
    constructor(authService, http, dialog, router, excelService, pdfService) {
    ...
    getList() {
        if (this.authService.userToken != null) {
            this.http.get(`${this.authService.API_URL}/taskList/sel/${this.authService.userToken}`).subscribe(res => {
                this.taskList = res;
            }, err => {
                console.log(err);
    ...
    exportExcel(taskId) {
        ...
        /* generate worksheet */
        const ws = xlsx__WEBPACK_IMPORTED_MODULE_4__["utils"].aoa_to_sheet(data);
...
WirelessListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: WirelessListComponent, selectors: [["app-wireless-list"]], viewQuery: function WirelessListComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 31, vars: 2, consts: [[1, "example-button-row"], ["mat-button", "", 3, "click"], [1, "planningList"], [1, "stat"], [1, "date"], [1, "min"], [4, "ngFor", "ngForOf"], [4, "ngIf"], ["id", "pdf_area", 2, "display", "none"], ["pdf", ""], ["mode", "determinate", 3, "value"], [1, "far", "fa-file-pdf", 3, "click"], [1, "fas", "fa-pencil-alt"], [1, "far", "fa-trash-alt"], [1, "fas", "fa-file-download", 3, "click"], ["colspan", "7", 1, "text-center"]], template: function WirelessListComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function WirelessListComponent_Template_button_click_3_listener() { return ctx.openDialog(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](WirelessListComponent, [{
    ...
    }], function () { return [{ type: _service_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] }, { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClient"] }, { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialog"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"] }, { type: _service_excel_service__WEBPACK_IMPORTED_MODULE_8__["ExcelService"] }, { type: _service_pdf_service__WEBPACK_IMPORTED_MODULE_9__["PdfService"] }]; }, { pdf: [{
...
/* harmony import */ var _site_pdf_pdf_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../site/pdf/pdf.module */ "./src/app/site/pdf/pdf.module.ts");
...
class WirelessListModule {
}
WirelessListModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: WirelessListModule });
WirelessListModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function WirelessListModule_Factory(t) { return new (t || WirelessListModule)(); }, providers: [], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WirelessListModule, { declarations: [_wireless_list_component__WEBPACK_IMPORTED_MODULE_3__["WirelessListComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _angular_router__WEBPACK_IMPORTED_MODULE_10__["RouterModule"],
        _wireless_list_routing_module__WEBPACK_IMPORTED_MODULE_2__["WirelessListRoutingModule"],
        _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_4__["MatButtonToggleModule"],
        _angular_material_button__WEBPACK_IMPORTED_MODULE_5__["MatButtonModule"],
        ...
        _ngx_translate_core__WEBPACK_IMPORTED_MODULE_9__["TranslateModule"],
        _site_pdf_pdf_module__WEBPACK_IMPORTED_MODULE_11__["PdfModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](WirelessListModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
                declarations: [
...
//# sourceMappingURL=wireless-list-wireless-list-module-es2015.js.map